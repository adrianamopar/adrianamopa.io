            ...
            yAxes: [{
                ticks: {
                    ...
                    callback: function(label, index, labels) {
                        return (is10(label) && (label / 1000 > 9 || label / 1000 == 1 || label / 1000 == 0.1 || label / 1000 == 0.01)) ? label / 1000 + 'k' : "";
                    }
                },
                scaleLabel: {
                    display: true,
...
function loadContent() {
        ...
        for (let i = 0; i < covidJsObj.Countries.length; i++) {
            newArray.push({
                ...
                "TotalConfirmedPer100000": covidJsObj.Countries[i].TotalConfirmedPer100000
            })
        ...
        chartData.options.title.text = "Covid 19 Hotspots on " + dayjs().format("MMMM") + " " + dayjs().format("D") + ", " + dayjs().format("YYYY");
